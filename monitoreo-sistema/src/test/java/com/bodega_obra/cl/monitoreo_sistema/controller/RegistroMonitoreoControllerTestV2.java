...
@WebMvcTest(RegistroMonitoreoControllerV2.class)
public class RegistroMonitoreoControllerTestV2 {
    @Autowired
    ...
    */
    ...
    public void testEnlistarRegistrosMonitoreo() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/registros-monitoreo"))
    ...
    public void testBuscarRegistroMonitoreo() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/registros-monitoreo/1"))
            .andExpect(status().isOk())
    ...
    public void testCrearRegistroMonitoreo() throws Exception {
        ...
        mockMvc.perform(post("/api/v2/registros-monitoreo")
    ...
    public void testActualizarRegistroMonitoreo() throws Exception {
        ...
        */
        ...
        mockMvc.perform(put("/api/v2/registros-monitoreo/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(registro)))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.id").value(1))
    ...
    public void testEliminarRegistroMonitoreo() throws Exception {
        ...
        mockMvc.perform(delete("/api/v2/registros-monitoreo/1"))
